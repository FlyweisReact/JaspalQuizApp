  ...
  return (
    <>
      ...
      <div className="grid-cont">
        ...
        {/* <img src={img} className="grid-item" alt="" /> 
        <img src={img2} className="grid-item" alt="" />
        <img src={img3} className="grid-item" alt="" />
        <img src={img4} className="grid-item" alt="" />
        <img src={img5} className="grid-item" alt="" />
        <img src={img6} className="grid-item" alt="" />
        <img src={img7} className="grid-item" alt="" />
  <img src={img8} className="grid-item" alt="" />*/}
      </div>
